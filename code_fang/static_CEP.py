...
# data_file = '../processed_data/mvlens_small/mvlens_10k.npy'
...
if data_type == 'static':
    ...
    data_dict['ind_tr'] = data_dict['tr_ind']
    data_dict['ind_te'] = data_dict['te_ind']
...
data_dict['y_tr'] = torch.tensor(data_dict['tr_y']).double()
